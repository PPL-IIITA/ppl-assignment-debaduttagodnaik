 ...
 * Function exchange() does an exchange of gifts between the couples and finds the k_most happiest by secondary mechanism.
 ...
 */
public class gift_exchangesecondary {
    public       make_couplessecondary obj = new make_couplessecondary();
     ...
     public   double[] happycoup = new double[1000];
        ...
        public void exchange(int b_no,int g_no,int k) throws IOException
    {
 

        obj.make(b_no,g_no);
        random_giftsecondary ran = new random_giftsecondary();
        ran.generate();
        int i,j;
        for(i=0;i<g_no;i++)
        {
