 ...
 * Function exchange() - Does only the exchange of gifts.
...
public class gift_exchangeonly {
     ...
     public   double[] happycoup = new double[1000];
        ...
        public void exchange(int b_no,int g_no,int k,make_couples tmp) throws IOException
    {
