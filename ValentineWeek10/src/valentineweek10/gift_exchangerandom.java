 ...
 * Function exchange() does an exchange of gifts between the couples randomly
 ...
 */
public class gift_exchangerandom {
public       make_couplesrandom obj = new make_couplesrandom();
        ...
        public void exchange(int b_no,int g_no,int k) throws IOException
    {
        ...
        obj.make(b_no,g_no);
        random_giftsrandom ran = new random_giftsrandom();
        ran.generate();
        int i,j;
        for(i=0;i<g_no;i++)
        {
