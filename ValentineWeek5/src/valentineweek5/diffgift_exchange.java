 ...
 * Function exchange() - Does the exchange of gifts and finds the k most happiest couple.
...
public class diffgift_exchange {
     public       make_diffcouples obj = new make_diffcouples();
